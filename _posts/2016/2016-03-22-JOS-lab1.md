...
当你观察bootloader的link address和load address时，它们是完全一致的，但是kernel的这两个地址却大不一样。
...
实际上，我们在下一个实验中将把PC物理内存最低的256MB地址空间，从0x00000000到0x0fffffff映射到虚拟地址从0xf0000000到0xffffffff
